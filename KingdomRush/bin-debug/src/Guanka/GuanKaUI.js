...
var GuanKaUI = (function (_super) {
    ...
    var __egretProto__ = GuanKaUI.prototype;
    /**返回按钮*/
    __egretProto__.backToMapsHandle = function (e) {
        TweenMax.killAll();
    ...
    /**UI出现动效*/
    __egretProto__.showUI = function () {
    ...
    /**设置金币数量*/
    __egretProto__.setGold = function (num) {
        this.goldTxt.text = num.toString();
    };
    /**设置生命*/
    __egretProto__.setLife = function (num) {
        this.lifeLeftTxt.text = num.toString();
    };
    /**设置波数*/
    __egretProto__.setBos = function (cur, total) {
        this.bos.text = cur.toString() + "/" + total.toString();
    };
    /**胜利*/
    __egretProto__.showVictory = function () {
        //画一个黑色蒙板
    ...
    /**失败*/
    __egretProto__.showLose = function () {
        //画一个黑色蒙板
    ...
    /**返回地图界面*/
    __egretProto__.spTouch1 = function (e) {
        TweenMax.killAll();
    ...
    /**阻止事件*/
    __egretProto__.spTouch2 = function (e) {
        e.stopPropagation();
    };
    return GuanKaUI;
})(egret.Sprite);
