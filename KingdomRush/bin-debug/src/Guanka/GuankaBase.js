...
var GuankaBase = (function (_super) {
    ...
    var __egretProto__ = GuankaBase.prototype;
    //================================
    /**背景地图被点击*/
    __egretProto__.bgMapClick = function (e) {
    ...
    //================================
    /**地图网格*/
    __egretProto__.makeGrid = function (path) {
        //解析地图json
    ...
    /**检查点击网格是否可通过*/
    __egretProto__.checkPoint = function (xnum, ynum) {
    ...
    /**创建地基*/
    __egretProto__.createBase = function (classFactory) {
    ...
    /**地基、塔 被点击*/
    __egretProto__.baseOrTowerTouch = function (e) {
        //鼠标互斥管理
        Group.selectItem(e.currentTarget);
    };
    /**出现建造工具*/
    __egretProto__.showTool = function (e) {
    ...
    /**隐藏建造工具*/
    __egretProto__.hideTool = function (e) {
    ...
    /**创建塔*/
    __egretProto__.buildTower = function (obj, towerName) {
        //反射 建立新塔 加入数组 添加侦听
    ...
    /**创建波*/
    __egretProto__.createEnemies = function (advancedTime) {
        //等待或则创建敌人
        if (!this.boing) {
    ...
    /**产生敌人*/
    __egretProto__.addEnemys = function (advancedTime, classFactory, roadArr) {
    ...
    /**实时刷新本方塔*/
    __egretProto__.enterFrameTowers = function (advancedTime) {
    ...
    /**退出关卡*/
    __egretProto__.quitHandle = function (e) {
        //打开loader界面加载地图界面
        Main.instance.dispatchEvent(new MainEvent(MainEvent.OPENLOADBAR, "maps"));
    };
    /**再次尝试*/
    __egretProto__.tryAgainHandle = function (e) {
    };
    /**关卡胜利*/
    __egretProto__.victory = function () {
        this.clear();
...
GuankaBase.prototype.__class__ = "GuankaBase";
