...
*
*/
var MagicTower03_1 = (function (_super) {
    __extends(MagicTower03_1, _super);
    function MagicTower03_1() {
        _super.call(this);
        this.minRadius = 100;
        this.maxRadius = 140;
        ...
        this.anchorX = 0.5;
        this.anchorY = 1;
        this.bm = Utils.createBitmapByName("MagicTower03_1");
    ...
    var __egretProto__ = MagicTower03_1.prototype;
    __egretProto__.onEnterFrame = function (advancedTime) {
        ...
        this.weapon.damage = 21;
        this.contentLayer.addChild(this.weapon);
        this.weapon.init(p1, this.target);
    };
    return MagicTower03_1;
})(MagicTowerBase);
MagicTower03_1.prototype.__class__ = "MagicTower03_1";
//# sourceMappingURL=MagicTower03_1.js.map