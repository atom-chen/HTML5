...
var ShieldTower03_1 = (function (_super) {
    ...
    function ShieldTower03_1() {
        ...
        this.anchorX = 0.5;
        this.anchorY = 1;
        this.bm = Utils.createBitmapByName("ShieldTower03_1");
        this.addChild(this.bm);
    }
    var __egretProto__ = ShieldTower03_1.prototype;
    /**初始化 3个士兵*/
    ...
    /**timer对象池产生士兵*/
    __egretProto__.createSold = function (e) {
        var posarr;
    ...
    /**集结点偏移量数组索引*/
    __egretProto__.addIdx = function () {
        this.offIdx++;
        if (this.offIdx > 2)
            this.offIdx = 0;
    };
    /**选中所有*/
    __egretProto__.allSelect = function (e) {
        //画绘制区域
        /*
    ...
    /**取消选中所有*/
    __egretProto__.allDeSelect = function (e) {
    ...
    /**移动所有*/
    __egretProto__.allMove = function (e) {
        while (this.areaLayer.numChildren > 0) {
            this.areaLayer.removeChildAt(0);
        }
        var arr = e.arr;
...
ShieldTower03_1.prototype.__class__ = "ShieldTower03_1";
//# sourceMappingURL=ShieldTower03_1.js.map