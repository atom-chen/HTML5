...
var ArrowTower03_1 = (function (_super) {
    ...
    function ArrowTower03_1() {
        ...
        this.anchorX = 0.5;
        this.anchorY = 1;
        this.bm = Utils.createBitmapByName("ArrowTower03_1");
        this.addChild(this.bm);
        ////创建左右ArrowShooter01
        this.st1 = new ArrowShooter031();
        this.st1.x = 36;
        this.st1.y = 5;
        this.addChild(this.st1);
        this.st2 = new ArrowShooter031();
        this.st2.x = 50;
        this.st2.y = 5;
    ...
    var __egretProto__ = ArrowTower03_1.prototype;
    /**实时刷新*/
    __egretProto__.onEnterFrame = function (advancedTime) {
        ...
        if (this.firstst == "L") {
            ...
            this.firstst = "R";
            //弓箭产生坐标点
            p1 = new egret.Point(this.sx - 5, this.sy - 54);
        }
...
//# sourceMappingURL=ArrowTower03_1.js.map