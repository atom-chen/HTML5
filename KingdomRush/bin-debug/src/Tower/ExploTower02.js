...
var ExploTower02 = (function (_super) {
    ...
    var __egretProto__ = ExploTower02.prototype;
    /**实时刷新*/
    __egretProto__.onEnterFrame = function (advancedTime) {
        ...
        //利用对象池产生弓箭对象并进行碰撞检测
        this.weapon = ObjectPool.getInstance().createObject(Explo02);
...
ExploTower02.prototype.__class__ = "ExploTower02";
//# sourceMappingURL=ExploTower02.js.map