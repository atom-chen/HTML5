...
var World = (function (_super) {
    ...
    var __egretProto__ = World.prototype;
    /**初始化*/
    ...
    /**取消旗帜侦听*/
    __egretProto__.removeLis = function () {
        var i;
        var flag;
        for (var i = 0; i < this.flagArr.length; i++) {
            flag = this.flagArr[i];
    ...
    /**创建选择面板*/
    __egretProto__.showXZ = function () {
    ...
    /**故事模式*/
    __egretProto__.gushiHandle = function (e) {
        Main.wujin = false;
        this.loadGuanka();
    };
    /**无尽模式*/
    __egretProto__.wujinHandle = function (e) {
        Main.wujin = true;
        this.loadGuanka();
    };
    /**关闭选择面板*/
    __egretProto__.closeHandle = function (e) {
    ...
    /**选择面板*/
    __egretProto__.choseGuanka = function (e) {
    ...
    /**选择模式*/
    __egretProto__.loadGuanka = function () {
        //加载资源
    ...
    /**返回主界面*/
    __egretProto__.backH = function (e) {
    ...
    /**打开英雄大厅UI面板*/
    __egretProto__.openHeroH = function (e) {
    };
    /*
    * 清除
    */
