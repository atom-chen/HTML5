...
var Main = (function (_super) {
     ...
     * 分组资源加载完成
     */
    __egretProto__.loadComp = function (e) {
        var str = e.groupName;
        switch (str) {
            case "preload":
     ...
     * 加载进度条 传递加载资源组名
     */
    __egretProto__.createLoadBar = function (e) {
    ...
    * 移除上一场景
    */
    __egretProto__.removeLast = function (e) {
        //加载新资源组
     ...
     * 根据分组资源创建相应关卡
     */
    __egretProto__.addSence = function (e) {
        //反射
    ...
    __egretProto__.onRotation = function (rotation) {
