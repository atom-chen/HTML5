...
var Boss01 = (function (_super) {
    ...
    var __egretProto__ = Boss01.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Boss01json");
        var texture = RES.getRes("Boss01png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Boss01");
...
Boss01.prototype.__class__ = "Boss01";
