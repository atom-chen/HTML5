 ...
 *
 */
var Monster09 = (function (_super) {
    __extends(Monster09, _super);
    function Monster09() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster09.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster09json");
        var texture = RES.getRes("Monster09png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster09");
...
Monster09.prototype.__class__ = "Monster09";
