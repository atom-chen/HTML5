 ...
 *
 */
var Monster05 = (function (_super) {
    __extends(Monster05, _super);
    function Monster05() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster05.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster05json");
        var texture = RES.getRes("Monster05png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster05");
...
Monster05.prototype.__class__ = "Monster05";
