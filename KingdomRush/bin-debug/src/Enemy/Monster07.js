 ...
 *
 */
var Monster07 = (function (_super) {
    __extends(Monster07, _super);
    function Monster07() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster07.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster07json");
        var texture = RES.getRes("Monster07png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster07");
...
Monster07.prototype.__class__ = "Monster07";
