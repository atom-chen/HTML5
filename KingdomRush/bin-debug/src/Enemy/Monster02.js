 ...
 *
 */
var Monster02 = (function (_super) {
    __extends(Monster02, _super);
    function Monster02() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster02.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster02json");
        var texture = RES.getRes("Monster02png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster02");
...
Monster02.prototype.__class__ = "Monster02";
