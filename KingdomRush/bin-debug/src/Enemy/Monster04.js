 ...
 *
 */
var Monster04 = (function (_super) {
    __extends(Monster04, _super);
    function Monster04() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster04.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster04json");
        var texture = RES.getRes("Monster04png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster04");
...
Monster04.prototype.__class__ = "Monster04";
