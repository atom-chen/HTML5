 ...
 *
 */
var Monster08 = (function (_super) {
    __extends(Monster08, _super);
    function Monster08() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster08.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster08json");
        var texture = RES.getRes("Monster08png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster08");
...
Monster08.prototype.__class__ = "Monster08";
