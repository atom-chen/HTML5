 ...
 *
 */
var Monster03 = (function (_super) {
    __extends(Monster03, _super);
    function Monster03() {
        _super.call(this);
        this.addTexture();
    }
    var __egretProto__ = Monster03.prototype;
    /**添加纹理 初始化数据*/
    __egretProto__.addTexture = function () {
        ...
        var data = RES.getRes("Monster03json");
        var texture = RES.getRes("Monster03png");
        var mcf = new egret.MovieClipDataFactory(data, texture);
        this.view.movieClipData = mcf.generateMovieClipData("Monster03");
...
Monster03.prototype.__class__ = "Monster03";
